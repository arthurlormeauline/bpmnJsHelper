package com.protectline.bpmninjs.jsprojectapi.jsupdater;
...
class FunctionJsUpdaterTest {
    ...
    void setUp() {
        ...
        functionJsUpdater = new FunctionJsUpdater(template);
    }
    ...
    void should_normalize_function_name_with_special_characters() {
        ...
        // When
        String result = functionJsUpdater.update("//<FUNCTIONS>", List.of(block));
