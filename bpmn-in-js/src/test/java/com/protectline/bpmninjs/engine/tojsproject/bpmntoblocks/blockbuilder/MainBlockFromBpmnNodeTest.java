...
class MainBlockFromBpmnNodeTest {

    private MainBlockFromBpmnNode builder;
    private FileService fileService;


    @BeforeEach
    void setup() throws URISyntaxException {
        builder = new MainBlockFromBpmnNode();
        var testDirectory = "tojsproject";
        var resourcePath = getResourcePath(MainBlockFromBpmnNodeTest.class, testDirectory);
    ...
    private static Stream<Arguments> shouldExtractAllBlocksData() {
        var scripBuilder = new ArrayList<BlockFromBpmnNode>();
        scripBuilder.add(new FunctionBlockFromBpmnNode());
        return Stream.of(
