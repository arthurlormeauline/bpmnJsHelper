...
//<435ec209-a46a-47b3-809a-fe263f4133a0>
    increment_retries_0() {
...
//<477d9866-772b-4634-a60d-544bf540c29e>
    Delay_definition_0() {
...
//<a342aba1-e659-4d8c-9890-e7a7e4fe2e4b>
...
//<6f645d9a-f482-4a31-9323-149947b7d409>
...
//<a0d9eb43-9ffa-4138-9159-0b19d119132a>
    Send_push__0() {
...
//<e7b04604-b8ac-4979-ae36-2935e4858d2d>
    Send_push__1() {
        statusCode;
    }
//<e7b04604-b8ac-4979-ae36-2935e4858d2d/>

//<694fc198-6394-450e-a263-e26fad43844d>
    Send_push__2() {
        var execution = connector.getParentVariableScope();
        if (statusCode != 200) {
            print("Push KO");
...
//<2e384222-a4c0-4f82-8bb4-35193218313f>
    Get_state_0() {
        var cameraId = execution.getVariable("constructorId");
        var customerId = execution.getVariable("customerId");
        var today = new Date();
...
//<f6e9f40c-0a65-46a8-a001-2dd6ce10fc0b>
    Get_state_1() {
        /* get activity id from parent*/
        var execution = connector.getParentVariableScope();
        var activityId = execution.getCurrentActivityId();
...
//<24f00cfd-ae4d-46f7-9442-4f7f2e46eea5>
...
//<fdde8915-f4e4-45f4-ab7e-d3838bffb76f>
...
//<ab3b870e-62fd-40f7-a2ee-e6afcdfd8a7b>
    Get_state_0() {
        var url_device= execution.getVariable('url_device');
        var cameraId = execution.getVariable('constructorId');
...
//<0c393b07-6ad4-44f0-8a03-5219ba7c229b>
    Get_state_1() {
        /* get activity id from parent*/
        var execution = connector.getParentVariableScope();
        var activityId = execution.getCurrentActivityId();
...
//<aa8f4665-3b31-4d2b-af9e-96f7778ee77f>
    Send_message_Kafka_0() {
        '{"response": "'+ execution.getVariable('bodyMessage')+'"}'
    }
//<aa8f4665-3b31-4d2b-af9e-96f7778ee77f/>

//<44d7074b-136b-4317-a3ed-2d13c0af02e1>
...
//<bacbb517-b08e-4ed6-a202-27ae46c0ad3d>
    Send_message_Kafka_0() {
        '{"gatewayId": "'+ execution.getVariable('constructorId')+'"}'
    }
//<bacbb517-b08e-4ed6-a202-27ae46c0ad3d/>

//<efbf2e49-f128-4f97-b7d8-fec8212e7bf0>
    Send_message_Kafka_1() {
        var resp = connector.getVariable('response')
        var respStatusCode = connector.getVariable('statusCode')
        print("Response status api send message kafka to TLS: " + respStatusCode + " " + resp);
...
//<2ebceee5-fd2e-4918-a0cd-0be1b946b5cd>
...
//<d251766d-421d-43c6-ba50-1f0bb07c34b7>
...
//<d05b1f29-fe9c-4ede-8ea3-b81ce6806bd3>
    Event_1u1d1qi_0() {
        var cameraId = execution.getVariable("constructorId");
        var customerId = execution.getVariable("customerId");
        var today = new Date();
